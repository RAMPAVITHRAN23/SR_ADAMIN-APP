...
class _SignUpState extends State<SignUp> {
                      ...
                      InkWell(
                        onTap: () async {
                          ...
                          if (await FetchLatLong(address!)) {
                            await userDetails.write(
                                "latlng", pharmacyDetails.latlng);
                            await userDetails.write(
                                "geoHash", pharmacyDetails.geoHash);
  ...
  Future<bool> FetchLatLong(String address) async {
    ...
    try {
      List<Location> locations = await locationFromAddress(targetAddress!);
